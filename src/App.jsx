  ...
  return (
    <div className='bg-black text-white min-h-screen w-screen flex flex-col box-border'>
      ...
      <nav className='fixed my-auto top-0 left-0 right-0 w-full flex justify-between p-7 text-[16px] bg-transparent'>
        <div className='w-1/3'>
          <span className='font-bold text-2xl transition-all duration-1000 animate-pulse text-red-500 shadow-2xl shadow-white ml-5 nav-item'>Franklin</span>
        </div>
        <div>
          <div className='bg-amber-400 animate-ping transition-all duration-2000 h-[50px] w-[50px] rounded-[50%] -mr-10'></div>
        </div>
        <div className='w-2/3'>
      ...
      <Shape />
      <Hero />
      <div className='h-[70px] w-[70px] rounded-[50%] bg-amber-400 animate-ping transition-all duration-2000 absolute left-10 shadow-sm'></div>
      <div className='bg-amber-400 w-[100px] rounded-[50%] animate-ping transition-colors duration-2000 h-[100px] shadow-lg shadow-white focus:outline-none focus:ring-2 focus:ring-pink-200 ml-[110vh]'></div>
      ...
      <div className='flex justify-around items-center'>
        <div className='flex flex-col gap-2 mx-5 text-center bg-white rounded-lg px-5 py-4 w-[300px] my-10'>
          ...
          <div className=''>{
          competences_frontend.map((competence, index) => (
            <div key={index} className='bg-black text-white my-2 border-l-5 rounded-l-sm border-amber-400 rounded-lg p-2 hover:shadow-sm hover:shadow-blue-500'>{competence}</div>
          ))}</div>
        </div>
        <div className='flex flex-col gap-2 mx-5 my-3 text-center bg-white rounded-lg px-5 py-4 w-[300px] shadow-lg shadow-gray-500 shadow-r-2'>
            ...
            <div>{competences_backend.map((competence, index) =>(
              <div className='bg-black text-white my-2 border-l-5 rounded-l-sm border-amber-400 rounded-lg p-2 hover:shadow-sm hover:shadow-blue-500' key={index}>{competence} </div>
            ) )}</div>
        </div>
        ...
        <div className='bg-dotted flex flex-col gap-2 mx-5 my-3 text-center bg-white rounded-lg px-5 py-4 w-[300px] shadow-lg shadow-gray-500 shadow-r-2'>
          ...
          <div>
            {langage_programmation.map((langage, index) => (
              <div key={index} className='bg-black text-white my-2 border-l-5 rounded-l-sm border-amber-400 rounded-lg p-2 hover:shadow-sm hover:shadow-blue-500'>{langage} </div>
            ) )}
          </div>
          
        </div>
      </div>
      <div className='rounded-full h-[45px] w-[45px] justify-center items-center bg-amber-400 animate-ping transition-all duration-2000 absolute left-10 shadow-sm'></div>
      </section>
      <section className=''>
        <h1 className='text-4xl white text-center font-extrabold'>Mes projets</h1>
        <div className=''>
          <div className='rounded-full bg-amber-800 h-[90px] w-[90px] justify-center ml-200 animate-ping transition-all duration-2000'></div>
          <div className='flex'>
